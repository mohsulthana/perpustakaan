        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              ...
              <a href="<?= base_url('reports/buku_report_by_category');?>">Laporan Buku Per Kategori</a>
            </div>
            <div class="d-flex flex-row-reverse container-fluid">
              <button onclick="window.location.href='<?= base_url('reports/cetak_buku_by_publisher');?>'" class="btn btn-success" data-toggle="modal" data-target="#addData"><i class="fas fa-print"></i> Cetak</button>
            </div>
