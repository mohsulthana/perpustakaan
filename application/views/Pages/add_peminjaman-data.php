            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="lama_pinjam" class="form-control" min="0"  step="1">
                  </div>
                </div>
              </div>
              <h1 style="color: grey;">Buku</h1>
                ...
                <div class="col-md-12">
                  ...
                  <button type="submit" name="tambahbuku" value="tambahbukuNew" class="btn btn-sm btn-success">Add book queue</button>
                  <hr>
                  <button type="submit" class="btn btn-sm btn-primary">Save transaction</button>
                <!-- <button type="submit" value="formtambah" name="tambahbuku">Tambah Buku</button>
              ...
              <table class="table align-items-center table-flush">
                ...
                <?php $no = 1; foreach($tmp_pinjam->result() as $tmp_pinjams) {?>
                  <tr>
                    ...
                    <td class="text-right">
                    <button type="submit" name="hapusBuku" value="hapusBukuNew" class="btn btn-sm btn-danger">Remove</button>
                    </td>
                  </tr>
                <?php }; ?>
                </tbody>
